  ...
  var PAGES = {
    ...
    grade:
      ...
      '<table><thead><tr><th>요소(줄)</th><th>배점</th><th>우수(만점) — 템플릿 기준 이행</th><th>보통</th><th>미흡(감점)</th></tr></thead><tbody>' +
        '<tr><td>정의<br>(03~05줄)</td><td>3</td><td>03 리드키워드=로마자 뒤 쌍따옴표·한글8/영문12자(트렌드·상위개념·표준 중 택) + 04 수단·메커니즘·사상 + 05 목적·범주 <b>명사형 종결</b></td><td>정의는 맞으나 리드키워드·목적 약함</td><td>부정확·서술형(~한다)·핵심어 누락</td></tr>' +
        '<tr><td>구성도<br>(07~13줄)</td><td>3</td><td>박스<code>[ ]</code>+화살표 <b>5줄</b>(08~12), 표준·통제·피드백 노드 포함, 세로 <code>↓</code> 방향·라벨 명확, <b>13줄 ※첨언</b></td><td>구조는 있으나 단조·방향 일부 모호</td><td>텍스트 나열·박스/화살표 부재</td></tr>' +
        '<tr><td>구성요소<br>(14~22줄)</td><td>3</td><td><b>3열(구분|구성요소|역할)×7행</b>(헤더1+본문6), 1열 분류 8유형 중 택, 셀 10~15자 명사형, <b>22줄 ※첨언(인접토픽)</b></td><td>본문 행 부족·분류 모호</td><td>표 부실·역할 설명 빈약</td></tr>' +
      ...
      '<ul>' +
        ...
        '<li><b>표·도해</b>: 표 셀 10~15자·명사형, 구성도 방향(→·↓) 명확, <b>시중 도해가 아닌 자신만의 창의적 도식</b>(차별화 +α).</li>' +
