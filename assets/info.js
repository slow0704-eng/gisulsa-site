...
(function () {
  ...
  var PAGES = {
    ...
    write:
      ...
      '</ul>' +
      '<p><b>줄단위 템플릿 (01~88)</b> — { } 안만 채움, 줄번호·위치 고정:</p>' +
      ...
      '<p style="margin:.4em 0 .2em;font-weight:700">【2면 · 23~44】 Q1 III + 간격 + Q2 문제+I+II구성도</p>' +
      '<pre class="diagram">23 | III. {토픽1}의 활용 및 발전방향\n24 |   적용: {적용 영역}→{사례}\n25 |   효과: {정량}·{정성}\n26 |   고려: {이슈}→{대응}\n27 |   전망: {발전·표준}\n28 |   {신축 관점5 — 사례:/성숙도: 등}\n29 |   {신축 관점6}\n30 |   ※ {III 첨언}          ← Q1 III=23~30=8\n31 | ─────(간격 1줄)─────\n32 | 문제 : {토픽2}에 대하여 설명하시오.\n33 | 답)\n34 | I. "{리드키워드}" {토픽2}의 정의\n35 |   {중간문}\n36 |   {마무리}\n37 | II. {토픽2}의 구성도 및 구성요소\n38 |  1. {토픽2}의 구성도\n39 |   {구성도 1행}\n40 |   {구성도 2행}\n41 |   {구성도 3행}\n42 |   {구성도 4행}\n43 |   {구성도 5행}\n44 |   ※ {구성도 첨언}          ← Q2 2-1=37~44=8</pre>' +
      '<p style="margin:.4em 0 .2em;font-weight:700">【3면 · 45~66】 Q2 II구성요소 + III + 간격 + Q3 문제+I</p>' +
      '<pre class="diagram">45 |  2. {토픽2}의 구성요소\n46 |   구분 | 구성요소 | 역할·기술\n47 |   {행1}\n48 |   {행2}\n49 |   {행3}\n50 |   {행4}\n51 |   {행5}\n52 |   {행6}\n53 |   ※ {구성요소 첨언}          ← Q2 2-2=45~53=9\n54 | III. {토픽2}의 활용 및 발전방향\n55 |   적용: {…}\n56 |   효과: {…}\n57 |   고려: {…}\n58 |   전망: {…}\n59 |   {신축 관점5}\n60 |   ※ {III 첨언}          ← Q2 III=54~60=7\n61 | ─────(간격 1줄)─────\n62 | 문제 : {토픽3}에 대하여 설명하시오.\n63 | 답)\n64 | I. "{리드키워드}" {토픽3}의 정의\n65 |   {중간문}\n66 |   {마무리}</pre>' +
      '<p style="margin:.4em 0 .2em;font-weight:700">【4면 · 67~88】 Q3 II(구성도·구성요소) + III</p>' +
      '<pre class="diagram">67 | II. {토픽3}의 구성도 및 구성요소\n68 |  1. {토픽3}의 구성도\n69 |   {구성도 1행}\n70 |   {구성도 2행}\n71 |   {구성도 3행}\n72 |   {구성도 4행}\n73 |   ※ {구성도 첨언}          ← Q3 2-1=67~73=7\n74 |  2. {토픽3}의 구성요소\n75 |   구분 | 구성요소 | 역할·기술\n76 |   {행1}\n77 |   {행2}\n78 |   {행3}\n79 |   {행4}\n80 |   {행5}\n81 |   {행6}\n82 |   ※ {구성요소 첨언}          ← Q3 2-2=74~82=9\n83 | III. {토픽3}의 활용 및 발전방향\n84 |   적용: {…}\n85 |   효과: {…}\n86 |   고려: {…}\n87 |   전망: {…}\n88 |   ※ {III 첨언}          ← Q3 III=83~88=6</pre>' +
      '<div class="info-note">※ 신축(면 정렬): III 구성도 기본 4줄 → 면 남으면 5~6줄(Q1=6·Q2=5·Q3=4). 문제·답 2줄, 구성요소 표 6행, 첨언 위치, 간격 1줄은 고정. 원본: <code>답안/답안템플릿_1교시_3단락_4장88줄.txt</code>.</div>' +
